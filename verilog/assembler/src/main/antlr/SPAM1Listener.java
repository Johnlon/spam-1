...
public interface SPAM1Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SPAM1Parser#instructions}.
	 * @param ctx the parse tree
	 */
	void enterInstructions(SPAM1Parser.InstructionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link SPAM1Parser#instructions}.
	 * @param ctx the parse tree
	 */
	void exitInstructions(SPAM1Parser.InstructionsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SPAM1Parser#op}.
	 * @param ctx the parse tree
	 */
	void enterOp(SPAM1Parser.OpContext ctx);
	/**
	 * Exit a parse tree produced by {@link SPAM1Parser#op}.
	 * @param ctx the parse tree
	 */
	void exitOp(SPAM1Parser.OpContext ctx);
	/**
	 * Enter a parse tree produced by {@link SPAM1Parser#passa}.
	 * @param ctx the parse tree
	 */
	void enterPassa(SPAM1Parser.PassaContext ctx);
	/**
	 * Exit a parse tree produced by {@link SPAM1Parser#passa}.
	 * @param ctx the parse tree
	 */
	void exitPassa(SPAM1Parser.PassaContext ctx);
	/**
	 * Enter a parse tree produced by {@link SPAM1Parser#passb}.
	 * @param ctx the parse tree
	 */
	void enterPassb(SPAM1Parser.PassbContext ctx);
	/**
	 * Exit a parse tree produced by {@link SPAM1Parser#passb}.
	 * @param ctx the parse tree
	 */
	void exitPassb(SPAM1Parser.PassbContext ctx);
	/**
