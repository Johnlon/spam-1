...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00000); // _ram_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10000); // _rega_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00001); // _marlo_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10001); // _regb_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00010); // _marhi_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10010); // _regc_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00011); // _uart_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10011); // _regd_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00100); // _pchitmp_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10100); // _rege_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00101); // _pclo_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10101); // _regf_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00110); // _pc_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10110); // _regg_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b00111); // _jmpo_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b10111); // _regh_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01000); // _jmpz_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11000); // _regi_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01001); // _jmpc_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11001); // _regj_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01010); // _jmpdi_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11010); // _regk_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01011); // _jmpdo_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11011); // _regl_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01100); // _jmpeq_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11100); // _regm_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01101); // _jmpne_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11101); // _regn_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01110); // _jmpgt_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11110); // _rego_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b01111); // _jmplt_in
...
`Equals(_alu_out, T);
`Equals(_uart_out, T);
`Equals(_device_in, 5'b11111); // _regp_in
