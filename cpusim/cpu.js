...
var clock = new events.EventEmitter();
var CLOCKUP = "CLOCKUP";
var CLOCKDN = "CLOCKND";
...
let aluBus = new Bus("aluBus")
let bBus = new Bus("bBus")
let aBus = new Bus("aBus")
let romDataBus = new Bus("romDataBus")

let control = new Control(romDataBus)

let pc = new PC(clock, control, aluBus)
