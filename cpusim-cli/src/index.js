...
const alu = new ALU(control, () => false, aBus, bBus);
...
assemble(rom, 0, Op.B, TDev.marlo, ADev.nu, BDev.immed, Cond.A, Flag.Set, CInv.CStd, AMode.Dir, 0, 0);
//assemble(rom, 1, Op.B,        TDev.marlo,   ADev.nu, BDev.immed, Cond.A, Flag.Set, CInv.CStd, AMode.Dir, 0, 0)
assemble(rom, 1, Op.B, TDev.marhi, ADev.nu, BDev.immed, Cond.A, Flag.Set, CInv.CStd, AMode.Dir, 0, 0);
assemble(rom, 2, Op.A_PLUS_B, TDev.marlo, ADev.marlo, BDev.immed, Cond.A, Flag.Set, CInv.CStd, AMode.Dir, 0, 1);
assemble(rom, 3, Op.B, TDev.pchitmp, ADev.nu, BDev.immed, Cond.A, Flag.Set, CInv.CStd, AMode.Dir, 0, 0);
//assemble(rom, 4, Op.B,        TDev.pc,      ADev.nu, BDev.immed, Cond.C, Flag.Set, CInv.CStd, AMode.Dir, 0, 2)
assemble(rom, 4, Op.B, TDev.halt, ADev.nu, BDev.immed, Cond.C, Flag.Set, CInv.CStd, AMode.Dir, 0, 0);
while (!clock.halted) {
    clock.cycle();
}
/*
