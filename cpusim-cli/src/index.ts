...
class ALU {
  ...
  constructor(control: Control, carryBit: () => boolean, abus: Bus, bbus: Bus) {
...
class Register implements BusSrc {
  ...
  constructor(name: string, clock: Clock, writeEnabled: () => boolean, outputEnabled: () => boolean, d: () => number) {
    this.name = name
    this.d = d
